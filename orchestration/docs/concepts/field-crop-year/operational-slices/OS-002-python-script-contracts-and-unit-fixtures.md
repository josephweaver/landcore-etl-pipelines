...
```text
orchestration/scripts/python/field_crop_common.py
orchestration/scripts/python/discover_raster_asset.py
orchestration/scripts/python/write_geospatial_request.py
orchestration/scripts/python/summarize_field_crop_counts.py
orchestration/tests/fixtures/counts/field_crop_counts_2010.csv
orchestration/tests/fixtures/counts/expected_field_crop_year_summary_2010.csv
orchestration/tests/test_summarize_field_crop_counts.py
orchestration/scripts/smoke/test_python_contracts.sh
...
```bash
python3 orchestration/tests/test_summarize_field_crop_counts.py
bash orchestration/scripts/smoke/test_python_contracts.sh
```
