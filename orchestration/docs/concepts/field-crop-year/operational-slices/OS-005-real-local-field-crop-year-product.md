...
```text
orchestration/workflows/local-field-crop-year-2010.workflow.json
orchestration/submissions/local-field-crop-year-2010.submission.json
orchestration/scripts/python/run_align_to_grid.py
orchestration/scripts/python/run_geospatial_pair_counts.py
orchestration/scripts/python/summarize_field_crop_counts.py
orchestration/scripts/python/validate_field_crop_year_product.py
orchestration/scripts/smoke/local_field_crop_year_2010.sh
...
```bash
bash orchestration/scripts/smoke/local_field_crop_year_2010.sh
```
