...
orchestration/workflows/local-synthetic-field-crop-year.workflow.json
orchestration/submissions/local-synthetic-field-crop-year.submission.json
orchestration/configs/local-controller.json
orchestration/configs/local-worker.gdal.json
orchestration/scripts/python/run_geospatial_pair_counts.py
orchestration/scripts/python/summarize_field_crop_counts.py
orchestration/scripts/smoke/local_synthetic_field_crop_year.sh
orchestration/tests/fixtures/mini/
...
```bash
bash orchestration/scripts/smoke/local_synthetic_field_crop_year.sh
```
...
Stop and append to `orchestration/docs/issues.md` if:
