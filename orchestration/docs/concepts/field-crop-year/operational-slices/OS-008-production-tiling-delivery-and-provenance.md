...
```text
orchestration/workflows/production-field-crop-year.workflow.json
orchestration/submissions/production-field-crop-year.template.json
orchestration/projects/landcore-field-crop-year.project.json
orchestration/scripts/python/merge_field_crop_year_outputs.py
orchestration/scripts/python/write_delivery_manifest.py
orchestration/scripts/python/validate_delivery_package.py
orchestration/scripts/python/write_gdrive_publish_plan.py
orchestration/scripts/smoke/production_dry_run.sh
orchestration/docs/delivery-format.md
orchestration/docs/production-runbook.md
...
record the blocker in `orchestration/docs/issues.md` instead of adding custom
GDAL commands.
...
```json
{
  ...
  "tiles_of_interest_source": "orchestration/docs/concepts/field-crop-year/SC-landcore-field-crop-year-data-product.md",
