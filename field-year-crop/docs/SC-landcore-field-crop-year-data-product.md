...
Runtime dependency: GORC / go-etl, pinned by commit in `field-year-crop/GORC_VERSION.md`
...
```text
land-core.project.json
field-year-crop/workflows/*.json
field-year-crop/submissions/*.json
field-year-crop/configs/*.json
field-year-crop/scripts/**/*.py
field-year-crop/scripts/**/*.R
field-year-crop/scripts/**/*.sh
field-year-crop/docs/**/*.md
field-year-crop/tests/**
```
