...
field-year-crop/workflows/gdrive-yanroy-connector-trial.workflow.json
field-year-crop/submissions/gdrive-yanroy-connector-trial.template.json
field-year-crop/configs/local-worker-gdrive.template.json
field-year-crop/configs/hpcc-worker-gdrive.template.json
field-year-crop/scripts/python/inspect_materialized_asset.py
field-year-crop/scripts/python/check_secret_materialization.py
field-year-crop/scripts/python/write_gdrive_publish_probe.py
field-year-crop/scripts/smoke/gdrive_connector_preflight.sh
field-year-crop/scripts/smoke/gdrive_connector_trial.sh
field-year-crop/scripts/smoke/gdrive_publish_probe.sh
field-year-crop/docs/gdrive-connector-runbook.md
...
```bash
bash field-year-crop/scripts/smoke/gdrive_connector_preflight.sh
bash field-year-crop/scripts/smoke/gdrive_connector_trial.sh
bash field-year-crop/scripts/smoke/gdrive_publish_probe.sh
```
